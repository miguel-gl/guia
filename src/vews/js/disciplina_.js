                ...
                else 
                {
                    ...
                    if(tema==tema_bd)
                    {
                        ...
                        if(asignatura!=0)
                        {
                            ...
                            {
                                if(pre==1){if(nivel_bd==1){resultados.push([j.id,j.subtema,cuerpo,disciplina,"Preescolar",idx,css,css2,css3]);}}
                                if(pri==1){if(nivel_bd==2){resultados.push([j.id,j.subtema,cuerpo,disciplina,"Primaria",idx,css,css2,css3]);}}
                                if(sec==1){if(nivel_bd==3){resultados.push([j.id,j.subtema,cuerpo,disciplina,"Secundaria",idx,css,css2,css3]);}}
                            }
                        }
                        else
                        {
                ...
                else 
                {
                    ...
                    if(busqueda!='Buscar...')
                    {
                        if (subtema.includes(busqueda))
                        {
                            ...
                            if(disciplina==19)
                            {
                                if(id_diciplina==19 || id_asignatura == 4)
                                {
                                    if(pre==1){if(nivel_bd==1){resultados.push([j.id,j.subtema,cuerpo,disciplina,"Preescolar",idx,css,css2,css3]);}}
                                    if(pri==1){if(nivel_bd==2){resultados.push([j.id,j.subtema,cuerpo,disciplina,"Primaria",idx,css,css2,css3]);}}
                                    if(sec==1){if(nivel_bd==3){resultados.push([j.id,j.subtema,cuerpo,disciplina,"Secundaria",idx,css,css2,css3]);}}
                                    /*Se desactiva la busqueda x signatura
                                    if(asignatura!=0)
                                    {
                                        if(id_asignatura==asignatura)
                                        {
                            ...
                            if(disciplina==1)
                            {
                                if(id_diciplina==1 || id_asignatura == 5 || id_asignatura ==6 || id_asignatura ==7 || id_asignatura ==15)
                                {
                                    if(pre==1){if(nivel_bd==1){resultados.push([j.id,j.subtema,cuerpo,disciplina,"Preescolar",idx,css,css2,css3]);}}
                                    if(pri==1){if(nivel_bd==2){resultados.push([j.id,j.subtema,cuerpo,disciplina,"Primaria",idx,css,css2,css3]);}}
                                    if(sec==1){if(nivel_bd==3){resultados.push([j.id,j.subtema,cuerpo,disciplina,"Secundaria",idx,css,css2,css3]);}}
                            ...
                            if(disciplina==18)
                            {
                                if(id_asignatura == 17 || id_asignatura ==10 || id_asignatura ==12)
                                {
                                    if(pre==1){if(nivel_bd==1){resultados.push([j.id,j.subtema,cuerpo,disciplina,"Preescolar",idx,css,css2,css3]);}}
                                    if(pri==1){if(nivel_bd==2){resultados.push([j.id,j.subtema,cuerpo,disciplina,"Primaria",idx,css,css2,css3]);}}
                                    if(sec==1){if(nivel_bd==3){resultados.push([j.id,j.subtema,cuerpo,disciplina,"Secundaria",idx,css,css2,css3]);}}
...
function temas(id_asignatura)
{
    ...
    var rol = localStorage.getItem("rol");
    var disciplina=localStorage.getItem("disciplina");
    var directorio="alumnos/articulos.json";
    if(rol!=1)
    {
        directorio="profesores/articulos_profesor.json"
    }
    $('#temas_select').html('<option value="" disabled selected>Buscar...</option>');
    let resultados = [];
    var path_bd="bd/"+directorio;
    $.getJSON(path_bd, function(datos) 
    {
        var json=datos[2]["data"];
        var idx=0;
        ...
        json.forEach(j => 
        {
            ...
            if(disciplina==19)
            {
                if(id_diciplina==19 || id_a == 4)
                {
                    if(pre==1 && nivel == 1)
                    {
                        nivel="Preescolar";
                        $('#temas_select').append('<option value="'+j.id+'">'+j.subtema+ ' ('+nivel+')</option>');
                    }
                    if(pri==1 && nivel == 2)
                    {
                        nivel="Primaria";
            ...
            if(disciplina==1)
            {
                if(id_diciplina==1 || id_a == 5 || id_a ==6 || id_a ==7 || id_a ==15)
                {
                    subtema = j.subtema.substring(0,200)+"...";
                    if(pre==1 && nivel == 1)
                    {
                        nivel="Preescolar";
                        $('#temas_select').append('<option value="'+j.id+'">'+subtema+ ' ('+nivel+')</option>');
                    }
                    if(pri==1 && nivel == 2)
                    {
                        nivel="Primaria";
    ...
    if(disciplina==19)
        {
            if(pre==1)
            {
                if(rol==1)
                {
                    //Se desactiva despelgar preescolar.
                    $('#tronco').hide();
                    $('#especial').hide();
                }
            }
        ...
        if(disciplina==18)
        {
            ...
            if(sec==1)
            {
                //Se desactiva select en ciencias ciencias(18);
            }
        ...
        if(disciplina==21)
        {
            ...
            if(pri==1 || sec==1)
            {
                //Se desactiva Select en ciencias ciencias(21);
            }
